...
export const GATE_PROVIDER_ID = "peep-gate";
const GATE_ACCOUNT_ISSUER = "https://example.test";
...
/**
 * Clear a stale marker when a `/get-session` arrives without `x-peep-identity`:
